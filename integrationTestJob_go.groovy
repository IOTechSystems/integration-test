...
def runNode() {
    ...
    def envMap =[
        'volume':'docker.iotechsys.com/edgexpert/docker-edgex-volume-x86_64:1.1.0',
        'mongo':'docker.iotechsys.com/edgexpert/docker-edgex-mongo-x86_64:1.1.0',
        'consul':'consul:1.1.0',
        'configSeed':'docker.iotechsys.com/edgexpert/docker-core-config-seed-go-x86_64:1.0.0',

        'coreData':'docker.iotechsys.com/edgexpert/core-data-go-x86_64:1.1.0',
        'coreMetadata':'docker.iotechsys.com/edgexpert/core-metadata-go-x86_64:1.1.0',
        'coreCommand':'docker.iotechsys.com/edgexpert/core-command-go-x86_64:1.1.0',
